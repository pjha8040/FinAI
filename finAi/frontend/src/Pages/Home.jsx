  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-900 to-blue-600 text-white">
      ...
      <nav className="bg-blue-800 bg-opacity-80 shadow-lg py-4 fixed w-full z-10 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="relative">
            ...
            <a
              href="/login"
              className="ml-6 px-4 py-2 bg-blue-500 rounded-lg hover:bg-blue-400 transition shadow-md"
            >
              Login
            </a>
          </div>
      ...
      <section className="text-center py-16 bg-blue-800 bg-opacity-80">
        ...
        <a
          href="/sign-up"
          className="mt-6 inline-block bg-white text-blue-700 px-6 py-3 rounded-lg text-lg font-semibold shadow-lg hover:bg-blue-200 transition"
        >
          Sign Up Now
        </a>
      </section>
